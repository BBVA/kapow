Feature: Kapow!'s read subcommand
  ...
  Scenario Outline: I'm warned when I fail to set mandatory flags
    ...
    | read       |                                                               | --data-url                                            | 1       | Error: Missing mandatory flag data-url's arg   |
    ...
    | read       | KAPOW_DATA_URL=http://localhost:8080                          | --handler-id                                          | 1       | Error: Missing mandatory flag handler-id's arg |
    | read       |                                                               | --data-url=http://localhost:8080 --handler-id         | 1       | Error: Missing mandatory flag handler-id's arg |
